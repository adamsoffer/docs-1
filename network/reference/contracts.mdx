...
description: "The Livepeer protocol contracts orchestrators, delegators, and applications interact with, and how to verify any address on-chain."
---
...
<Note>
  **Historical:** before the 2022 Confluence migration the protocol ran on Ethereum mainnet; those
  ...
  Arbitrum One. Migration-era and genesis-era contract code lives on the protocol repo's
